...
#define CAPS_LOCK_LED_INDEX 77

/* Enable NUM_LOCK_LED_INDEX */
#define NUM_LOCK_LED_INDEX 23

/* Bootmagic, so we can start bootloader without button */
/* We define it as the ESC key */
...
#define WS2812_DI_PIN F7 //  pin 10, wierd name
